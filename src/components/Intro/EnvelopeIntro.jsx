...
export default function EnvelopeIntro({ onFinish, onOpen }) {
  ...
  return (
    <div className="fixed inset-0 z-50 h-[100svh] w-screen overflow-hidden">
      <div
        style={{
        ...
        className={`
          absolute bottom-0 left-0 w-full h-[50svh]
          bg-[#f1ede6]
          transition-all
      ...
      <div
        ...
        className={`
          absolute top-0 left-0 w-full h-[50svh]
          bg-[#f8f5f0]
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            <img
              ...
              className="w-55 sm:w-70 h-auto object-cover subtle-pulse"
            />
          </button>
        </div>
      )}
